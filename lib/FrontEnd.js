function generateLikeGIF() {
    ...
    if (options.enableUnpushed) {
        ...
        unpushedIcon = getCenterScaledCanvas(unpushedIcon, options.size, 0.8, options.disenableSmooth);
    ...
    for (var idx = 1; idx <= 80; idx++) {
        ...
        canvasBlockCtx = null;
        generateIconAnimationOnCanvas(idx, canvasBlock, options.iconImg, options.disenableSmooth);
